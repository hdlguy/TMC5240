...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -type clk clkin100
  ...
  connect_bd_net -net microblaze_0_Clk  [get_bd_pins clkin100] \
...
proc create_root_design { parentCell } {
  ...
  [get_bd_pins rst_clkin100_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk_2  [get_bd_ports clkin100] \
  [get_bd_pins microblaze_0/Clk] \
  [get_bd_pins microblaze_0_local_memory/clkin100] \
  [get_bd_pins rst_clkin100_100M/slowest_sync_clk] \
  ...
  [get_bd_pins rst_clkin100_100M/ext_reset_in] \
